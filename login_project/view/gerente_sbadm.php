...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content"><main><div class="container-fluid px-4">
            ...
            <div class="card mb-4"><div class="card-header"><i class="fas fa-table me-1"></i> VENTAS RECIENTES</div><div class="card-body table-responsive"><table class="table table-striped table-bordered"><thead><tr><th>ID Venta</th><th>Fecha</th><th>Cliente</th><th>Total</th><th>Estado</th></tr></thead><tbody><?php foreach ($recentSales as $sale): ?><tr><td><?php echo (int) $sale['id_venta']; ?></td><td><?php echo htmlspecialchars($sale['fecha_venta'], ENT_QUOTES, 'UTF-8'); ?></td><td><?php echo htmlspecialchars($sale['cliente'] ?? 'Sin cliente', ENT_QUOTES, 'UTF-8'); ?></td><td>$ <?php echo number_format((float) $sale['total'], 0, ',', '.'); ?></td><td><?php echo htmlspecialchars($sale['estado'], ENT_QUOTES, 'UTF-8'); ?></td></tr><?php endforeach; ?><?php if (!$recentSales): ?><tr><td colspan="5" class="text-center text-muted">No hay ventas registradas.</td></tr><?php endif; ?></tbody></table></div></div>

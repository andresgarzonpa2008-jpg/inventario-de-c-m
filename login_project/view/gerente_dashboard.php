...
<body class="bg-gray-900 text-white min-h-screen gerente-dashboard">
    ...
    <aside class="gerente-sidebar" id="gerenteSidebar">
        ...
        <?php if ($role === 'admin'): ?><a class="nav-link text-white px-3 py-3" href="index.php?action=usuario&section=usuarios"><i class="fas fa-users fa-fw me-2"></i>Usuarios</a><?php endif; ?>

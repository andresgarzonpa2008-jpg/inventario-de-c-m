...
if ($id_usuario > 0) {
    try {
        ...
        $query = "SELECT id, nombre, apellido, username, correo, rol, documento_id, fecha_nacimiento FROM usuarios WHERE id = :id";
...
<div class="container-fluid px-4">
    ...
    <?php if (!empty($error_editar)): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <i class="fas fa-exclamation-circle"></i> <?php echo $error_editar; ?>
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        </div>
    <?php endif; ?>
